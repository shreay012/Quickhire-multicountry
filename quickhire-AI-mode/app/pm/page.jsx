...
export default function PmDashboard() {
  ...
  return (
    <div>
      <PageHeader title="My Dashboard" subtitle="Bookings assigned to you" />
        ...
        {data && (
          <>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <StatCard label="Assigned" value={data.assigned} color="green" />
              <StatCard label="In Progress" value={data.inProgress} color="orange" />
              <StatCard label="Paused" value={data.paused || 0} color="orange" />
              <StatCard label="Completed" value={data.completed} color="slate" />
            </div>
